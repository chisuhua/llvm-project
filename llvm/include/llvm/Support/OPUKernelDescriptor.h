...
//
/// \file
/// OPU kernel descriptor definitions. For more information, visit
/// https://llvm.org/docs/AMDGPUUsage.html#kernel-descriptor
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_SUPPORT_OPUKERNELDESCRIPTOR_H
#define LLVM_SUPPORT_OPUKERNELDESCRIPTOR_H
...
#ifndef OPU_BITS_ENUM_ENTRY
#define OPU_BITS_ENUM_ENTRY(NAME, SHIFT, WIDTH) \
  NAME ## _SHIFT = (SHIFT),                        \
  NAME ## _WIDTH = (WIDTH),                        \
  NAME = (((1 << (WIDTH)) - 1) << (SHIFT))
#endif // OPU_BITS_ENUM_ENTRY

// Gets bits for specified bit mask from specified source.
#ifndef OPU_BITS_GET
#define OPU_BITS_GET(SRC, MSK) ((SRC & MSK) >> MSK ## _SHIFT)
#endif // OPU_BITS_GET

// Sets bits for specified bit mask in specified destination.
#ifndef OPU_BITS_SET
#define OPU_BITS_SET(DST, MSK, VAL)  \
  DST &= ~MSK;                          \
...
#define COMPUTE_PGM_RSRC1(NAME, SHIFT, WIDTH) \
  OPU_BITS_ENUM_ENTRY(COMPUTE_PGM_RSRC1_ ## NAME, SHIFT, WIDTH)
enum : int32_t {
...
#define COMPUTE_PGM_RSRC2(NAME, SHIFT, WIDTH) \
  OPU_BITS_ENUM_ENTRY(COMPUTE_PGM_RSRC2_ ## NAME, SHIFT, WIDTH)
enum : int32_t {
...
#define COMPUTE_PGM_RSRC3_GFX90A(NAME, SHIFT, WIDTH) \
  OPU_BITS_ENUM_ENTRY(COMPUTE_PGM_RSRC3_GFX90A_ ## NAME, SHIFT, WIDTH)
enum : int32_t {
...
#define COMPUTE_PGM_RSRC3_GFX10(NAME, SHIFT, WIDTH) \
  OPU_BITS_ENUM_ENTRY(COMPUTE_PGM_RSRC3_GFX10_ ## NAME, SHIFT, WIDTH)
enum : int32_t {
...
#define KERNEL_CODE_PROPERTY(NAME, SHIFT, WIDTH) \
  OPU_BITS_ENUM_ENTRY(KERNEL_CODE_PROPERTY_ ## NAME, SHIFT, WIDTH)
enum : int32_t {
...
#endif // LLVM_SUPPORT_OPUKERNELDESCRIPTOR_H
