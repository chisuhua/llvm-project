...
//
/// \file
/// OPU metadata definitions and in-memory representations.
///
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_SUPPORT_OPUMETADATA_H
#define LLVM_SUPPORT_OPUMETADATA_H
...
#endif // LLVM_SUPPORT_OPUMETADATA_H
