//===- OPUMetadataVerifier.h - MsgPack Types -----------------*- C++ -*-===//
//
...
//
/// \file
/// This is a verifier for OPU HSA metadata, which can verify both
...
#ifndef LLVM_BINARYFORMAT_OPUMETADATAVERIFIER_H
#define LLVM_BINARYFORMAT_OPUMETADATAVERIFIER_H
...
#endif // LLVM_BINARYFORMAT_OPUMETADATAVERIFIER_H
