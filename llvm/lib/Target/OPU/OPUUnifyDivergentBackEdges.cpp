...
//===----------------------------------------------------------------------===//
//
// This change all loop with multi divergent back edges. insert a unified
// backedge block.
// It may improve the covergage under simt solution
//
//===----------------------------------------------------------------------===//
...
class OPUUnifyDivergentBackEdges : public FunctionPass {
public:
  static char ID; // Pass identification, replacement for typeid

  OPUUnifyDivergentBackEdges() : FunctionPass(ID) {
    initializeOPUUnifyDivergentBackEdgesPass(*PassRegistry::getPassRegistry());
  }
...
char OPUUnifyDivergentBackEdges::ID = 0;

char &llvm::OPUUnifyDivergentBackEdgesID = OPUUnifyDivergentBackEdges::ID;

INITIALIZE_PASS_BEGIN(OPUUnifyDivergentBackEdges, DEBUG_TYPE,
                     "Unify divergent function exit nodes", false, false)
INITIALIZE_PASS_DEPENDENCY(PostDominatorTreeWrapperPass)
INITIALIZE_PASS_DEPENDENCY(LegacyDivergenceAnalysis)
INITIALIZE_PASS_END(OPUUnifyDivergentBackEdges, DEBUG_TYPE,
                    "Unify divergent function exit nodes", false, false)

void OPUUnifyDivergentBackEdges::getAnalysisUsage(AnalysisUsage &AU) const{
...
bool OPUUnifyDivergentBackEdges::runOnFunction(Function &F) {
