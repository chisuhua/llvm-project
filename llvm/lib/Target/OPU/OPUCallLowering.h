//===- lib/Target/OPU/OPUCallLowering.h - Call lowering -*- C++ -*---===//
//
...
#ifndef LLVM_LIB_TARGET_OPU_OPUCALLLOWERING_H
#define LLVM_LIB_TARGET_OPU_OPUCALLLOWERING_H
...
class OPUTargetLowering;

class OPUCallLowering: public CallLowering {
...
public:
  OPUCallLowering(const OPUTargetLowering &TLI);
