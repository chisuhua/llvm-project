//===-- OPUInstPrinter.h - Convert OPU MCInst to asm syntax ---*- C++ -*--//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints a OPU MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_OPU_MCTARGETDESC_OPUINSTPRINTER_H
#define LLVM_LIB_TARGET_OPU_MCTARGETDESC_OPUINSTPRINTER_H
...
class OPUInstPrinter : public MCInstPrinter {
public:
  const MCInstrInfo &MII;
  OPUInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
  ...
  static const char *getRegisterName(unsigned RegNo,
                                     unsigned AltIdx = OPU::ABIRegAltName);
