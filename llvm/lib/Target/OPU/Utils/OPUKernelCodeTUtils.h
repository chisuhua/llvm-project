//===- PPUKernelCodeTUtils.h - helpers for amd_kernel_code_t -*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_PPU_UTILS_AMDKERNELCODETUTILS_H
#define LLVM_LIB_TARGET_PPU_UTILS_AMDKERNELCODETUTILS_H
...
#endif // LLVM_LIB_TARGET_PPU_UTILS_AMDKERNELCODETUTILS_H
