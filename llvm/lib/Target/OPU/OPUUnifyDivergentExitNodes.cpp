...
class OPUUnifyDivergentExitNodes : public FunctionPass {
public:
  static char ID; // Pass identification, replacement for typeid

  OPUUnifyDivergentExitNodes() : FunctionPass(ID) {
    initializeOPUUnifyDivergentExitNodesPass(*PassRegistry::getPassRegistry());
  }
...
char OPUUnifyDivergentExitNodes::ID = 0;

char &llvm::OPUUnifyDivergentExitNodesID = OPUUnifyDivergentExitNodes::ID;

INITIALIZE_PASS_BEGIN(OPUUnifyDivergentExitNodes, DEBUG_TYPE,
                     "Unify divergent function exit nodes", false, false)
INITIALIZE_PASS_DEPENDENCY(PostDominatorTreeWrapperPass)
INITIALIZE_PASS_DEPENDENCY(LegacyDivergenceAnalysis)
INITIALIZE_PASS_END(OPUUnifyDivergentExitNodes, DEBUG_TYPE,
                    "Unify divergent function exit nodes", false, false)

void OPUUnifyDivergentExitNodes::getAnalysisUsage(AnalysisUsage &AU) const{
...
bool OPUUnifyDivergentExitNodes::runOnFunction(Function &F) {
