//===- OPUPerfHintAnalysis.h ---- analysis of memory traffic -*- C++ -*-===//
//
...
#ifndef LLVM_LIB_TARGET_OPU_MDGPUPERFHINTANALYSIS_H
#define LLVM_LIB_TARGET_OPU_MDGPUPERFHINTANALYSIS_H
...
struct OPUPerfHintAnalysis : public CallGraphSCCPass {
  static char ID;

public:
  OPUPerfHintAnalysis() : CallGraphSCCPass(ID) {}
...
#endif // LLVM_LIB_TARGET_OPU_MDGPUPERFHINTANALYSIS_H
