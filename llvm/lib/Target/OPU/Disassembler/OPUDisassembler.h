//===- OPUDisassembler.hpp - Disassembler for OPU ISA -----*- C++ -*-===//
//
...
/// \file
///
/// This file contains declaration for OPU ISA disassembler
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_OPU_DISASSEMBLER_OPUDISASSEMBLER_H
#define LLVM_LIB_TARGET_OPU_DISASSEMBLER_OPUDISASSEMBLER_H
...
public:
  ...
  ~OPUDisassembler() override = default;
...
class OPUSymbolizer : public MCSymbolizer {
private:
  void *DisInfo;

public:
  OPUSymbolizer(MCContext &Ctx, std::unique_ptr<MCRelocationInfo> &&RelInfo,
                   void *disInfo)
...
#endif // LLVM_LIB_TARGET_OPU_DISASSEMBLER_OPUDISASSEMBLER_H
